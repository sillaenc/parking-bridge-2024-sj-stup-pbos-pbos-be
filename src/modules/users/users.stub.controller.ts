...
export class UsersStubController {
  ...
  async patch_users_account_password() {
    throw new HttpException(
      'Not implemented: PATCH /api/v1/users/{account}/password',
  ...
  async patch_users_account_password_reset() {
    throw new HttpException(
      'Not implemented: PATCH /api/v1/users/{account}/password/reset',
      HttpStatus.NOT_IMPLEMENTED,
    );
  }
  ...
  async post_users_legacy_updateUser() {
    throw new HttpException(
      'Not implemented: POST /api/v1/users/legacy/updateUser',
      HttpStatus.NOT_IMPLEMENTED,
    );
  }
  ...
  async post_users_legacy_changePassword() {
    throw new HttpException(
      'Not implemented: POST /api/v1/users/legacy/changePassword',
      HttpStatus.NOT_IMPLEMENTED,
    );
  }
  ...
  async post_users_legacy_resetPassword() {
    throw new HttpException(
      'Not implemented: POST /api/v1/users/legacy/resetPassword',
      HttpStatus.NOT_IMPLEMENTED,
    );
  }
  ...
  async post_users_legacy_insertUser() {
    throw new HttpException(
      'Not implemented: POST /api/v1/users/legacy/insertUser',
      HttpStatus.NOT_IMPLEMENTED,
    );
  }
  ...
  async post_users_legacy_deleteUser() {
    throw new HttpException(
      'Not implemented: POST /api/v1/users/legacy/deleteUser',
      HttpStatus.NOT_IMPLEMENTED,
    );
  }
